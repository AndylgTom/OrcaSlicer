var LangText = {
  ...
  ru_RU: {
    ...
    orca4: "Это остановит передачу данных в облачные сервисы Bambu. Пользователи, которые не используют принтеры Bambu Lab или используют их в режиме «Только LAN», могут безопасно включить эту опцию.",
